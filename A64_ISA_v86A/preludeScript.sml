...
open lem_pervasives_extra_sailTheory sail2_instr_kindsTheory sail2_valuesTheory sail2_operators_mwordsTheory sail2_prompt_monadTheory sail2_promptTheory;
...
val _ = Define `
 ((ReadMemory:int ->(56)words$word -> 'rv sail2_state_monad$sequential_state ->(('n words$word),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) n addr=  (sail2_state_monad$read_memS 
  instance_Sail2_values_Bitvector_Machine_word_mword_dict instance_Sail2_values_Bitvector_Machine_word_mword_dict Read_plain (( 56 : int):int) addr n))`;

(*val __WriteMemory : forall 'rv 'n 'e. Size 'n => integer -> mword ty56 -> mword 'n -> monad 'rv unit 'e*)
val _ = Define `
 ((WriteMemory:int ->(56)words$word -> 'n words$word -> 'rv sail2_state_monad$sequential_state ->((unit),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) n addr data=  (sail2_state_monad$bindS (sail2_state_monad$write_memS 
  instance_Sail2_values_Bitvector_Machine_word_mword_dict instance_Sail2_values_Bitvector_Machine_word_mword_dict Write_plain (( 56 : int):int) addr n data) 
