...
open lem_string_sailTheory lem_maybeTheory lem_numTheory lem_basic_classesTheory lem_setTheory lem_relationTheory lem_showTheory lem_set_extra_sailTheory lem_string_extra_sailTheory;
...
((instance_Show_Show_Num_int_dict:(int)Show_class)= (<|
  ...
  show_method := lem_string_extra_sail$stringFromInt|>))`;


val _ = Define `
((instance_Show_Show_Num_integer_dict:(int)Show_class)= (<|

  show_method := lem_string_extra_sail$stringFromInteger|>))`;
