...
open lem_pervasives_extra_sailTheory sail2_valuesTheory sail2_instr_kindsTheory sail2_state_monadTheory;
...
val _ = Define `
 ((barrier:'c -> 'a sequential_state ->((unit),'b)result#'a sequential_state) _=  (returnS () ))`;

val _ = Define `
 ((footprint:'c -> 'a sequential_state ->((unit),'b)result#'a sequential_state) _=  (returnS () ))`;
