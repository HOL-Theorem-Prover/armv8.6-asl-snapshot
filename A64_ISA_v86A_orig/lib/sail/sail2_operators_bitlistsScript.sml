...
val _ = Define `
 ((uint_fail0:'a Bitvector_class -> 'a -> 'b sail2_state_monad$sequential_state ->((int),'c)sail2_state_monad$result#'b sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a v=  (sail2_state_monad$maybe_failS "uint" (
  dict_Sail2_values_Bitvector_a.unsigned_method v)))`;

val _ = Define `
 ((uint_nondet0:(bitU)list -> 'a sail2_state_monad$sequential_state ->((int),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) v=  (sail2_state_monad$bindS
...
val _ = Define `
 ((sint_fail0:'a Bitvector_class -> 'a -> 'b sail2_state_monad$sequential_state ->((int),'c)sail2_state_monad$result#'b sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a v=  (sail2_state_monad$maybe_failS "sint" (
  dict_Sail2_values_Bitvector_a.signed_method v)))`;

val _ = Define `
 ((sint_nondet0:(bitU)list -> 'a sail2_state_monad$sequential_state ->((int),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) v=  (sail2_state_monad$bindS
  (sail2_state$bools_of_bits_nondetS v) (\ bs . 
...
val _ = Define `
 ((update_vec_inc_fail0:(bitU)list -> int -> bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) v i b=  (sail2_state_monad$returnS (update_vec_inc0 v i b)))`;

val _ = Define `
 ((update_vec_inc_nondet0:(bitU)list -> int -> bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) v i b=  (sail2_state_monad$returnS (update_vec_inc0 v i b)))`;
...
val _ = Define `
 ((update_vec_dec_fail0:(bitU)list -> int -> bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) v i b=  (sail2_state_monad$returnS (update_vec_dec0 v i b)))`;

val _ = Define `
 ((update_vec_dec_nondet0:(bitU)list -> int -> bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) v i b=  (sail2_state_monad$returnS (update_vec_dec0 v i b)))`;
...
val _ = Define `
 ((cons_vec_fail0:bitU ->(bitU)list -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) b v=  (sail2_state_monad$returnS (cons_vec0 b v)))`;

val _ = Define `
 ((cons_vec_nondet0:bitU ->(bitU)list -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) b v=  (sail2_state_monad$returnS (cons_vec0 b v)))`;
...
val _ = Define `
 ((cast_unit_vec_fail0:bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) b=  (sail2_state_monad$returnS (cast_unit_vec0 b)))`;

val _ = Define `
 ((cast_unit_vec_nondet0:bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) b=  (sail2_state_monad$returnS (cast_unit_vec0 b)))`;
...
val _ = Define `
 ((vec_of_bit_fail0:int -> bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) len b=  (sail2_state_monad$returnS (vec_of_bit0 len b)))`;

val _ = Define `
 ((vec_of_bit_nondet0:int -> bitU -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) len b=  (sail2_state_monad$returnS (vec_of_bit0 len b)))`;
...
val _ = Define `
 ((int_of_vec_fail0:bool ->(bitU)list -> 'a sail2_state_monad$sequential_state ->((int),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) sign v=  (sail2_state_monad$maybe_failS "int_of_vec" (int_of_vec_maybe0 sign v)))`;

val _ = Define `
 ((int_of_vec_nondet:bool ->(bitU)list -> 'a sail2_state_monad$sequential_state ->((int),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) sign v=  (sail2_state_monad$bindS (sail2_state$bools_of_bits_nondetS v) (\ v .  sail2_state_monad$returnS (int_of_bools sign v))))`;
...
val _ = Define `
 ((add_vec_bit_fail0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a   l r=  (sail2_state_monad$maybe_failS "add_vec_bit" (add_vec_bit_maybe0 
  dict_Sail2_values_Bitvector_a l r)))`;

val _ = Define `
 ((add_vec_bit_nondet0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a l r=  (sail2_state_monad$bindS (sail2_state$bool_of_bitU_nondetS r) (\ r .  sail2_state_monad$returnS (add_vec_bool0 
  dict_Sail2_values_Bitvector_a l r))))`;
...
val _ = Define `
 ((adds_vec_bit_fail0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a   l r=  (sail2_state_monad$maybe_failS "adds_vec_bit" (adds_vec_bit_maybe0 
  dict_Sail2_values_Bitvector_a l r)))`;

val _ = Define `
 ((adds_vec_bit_nondet0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a l r=  (sail2_state_monad$bindS (sail2_state$bool_of_bitU_nondetS r) (\ r .  sail2_state_monad$returnS (adds_vec_bool0 
  dict_Sail2_values_Bitvector_a l r))))`;
...
val _ = Define `
 ((sub_vec_bit_fail0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a    l r=  (sail2_state_monad$maybe_failS "sub_vec_bit" (sub_vec_bit_maybe0 
  dict_Sail2_values_Bitvector_a l r)))`;

val _ = Define `
 ((sub_vec_bit_nondet0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a  l r=  (sail2_state_monad$bindS (sail2_state$bool_of_bitU_nondetS r) (\ r .  sail2_state_monad$returnS (sub_vec_bool0 
  dict_Sail2_values_Bitvector_a l r))))`;
...
val _ = Define `
 ((subs_vec_bit_fail0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a   l r=  (sail2_state_monad$maybe_failS "sub_vec_bit" (subs_vec_bit_maybe0 
  dict_Sail2_values_Bitvector_a l r)))`;

val _ = Define `
 ((subs_vec_bit_nondet0:'a Bitvector_class -> 'a -> bitU -> 'c sail2_state_monad$sequential_state ->('a,'d)sail2_state_monad$result#'c sail2_state_monad$sequential_state)dict_Sail2_values_Bitvector_a l r=  (sail2_state_monad$bindS (sail2_state$bool_of_bitU_nondetS r) (\ r .  sail2_state_monad$returnS (subs_vec_bool0 
  dict_Sail2_values_Bitvector_a l r))))`;
...
val _ = Define `
 ((mod_vec_fail0:(bitU)list ->(bitU)list -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state)   l r=  (sail2_state_monad$maybe_failS "mod_vec" (mod_bv 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) (instance_Sail2_values_Bitvector_list_dict
   instance_Sail2_values_BitU_Sail2_values_bitU_dict) l r)))`;

val _ = Define `
 ((mod_vec_nondet0:(bitU)list ->(bitU)list -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) l r=  (sail2_state$of_bits_nondetS 
  (instance_Sail2_values_Bitvector_list_dict
...
val _ = Define `
 ((quot_vec_fail0:(bitU)list ->(bitU)list -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state)   l r=  (sail2_state_monad$maybe_failS "quot_vec" (quot_bv 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) (instance_Sail2_values_Bitvector_list_dict
   instance_Sail2_values_BitU_Sail2_values_bitU_dict) l r)))`;

val _ = Define `
 ((quot_vec_nondet0:(bitU)list ->(bitU)list -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) l r=  (sail2_state$of_bits_nondetS 
  (instance_Sail2_values_Bitvector_list_dict
...
val _ = Define `
 ((quots_vec_fail0:(bitU)list ->(bitU)list -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state)   l r=  (sail2_state_monad$maybe_failS "quots_vec" (quots_bv 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) (instance_Sail2_values_Bitvector_list_dict
   instance_Sail2_values_BitU_Sail2_values_bitU_dict) l r)))`;

val _ = Define `
 ((quots_vec_nondet0:(bitU)list ->(bitU)list -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) l r=  (sail2_state$of_bits_nondetS 
  (instance_Sail2_values_Bitvector_list_dict
...
val _ = Define `
 ((mod_vec_int_fail0:(bitU)list -> int -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state)   l r=  (sail2_state_monad$maybe_failS "mod_vec_int" (mod_bv_int 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) (instance_Sail2_values_Bitvector_list_dict
   instance_Sail2_values_BitU_Sail2_values_bitU_dict) l r)))`;

val _ = Define `
 ((mod_vec_int_nondet0:(bitU)list -> int -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) l r=  (sail2_state$of_bits_nondetS 
  (instance_Sail2_values_Bitvector_list_dict
...
val _ = Define `
 ((quot_vec_int_fail0:(bitU)list -> int -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state)   l r=  (sail2_state_monad$maybe_failS "quot_vec_int" (quot_bv_int 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) (instance_Sail2_values_Bitvector_list_dict
   instance_Sail2_values_BitU_Sail2_values_bitU_dict) l r)))`;

val _ = Define `
 ((quot_vec_int_nondet0:(bitU)list -> int -> 'rv sail2_state_monad$sequential_state ->(((bitU)list),'e)sail2_state_monad$result#'rv sail2_state_monad$sequential_state) l r=  (sail2_state$of_bits_nondetS 
  (instance_Sail2_values_Bitvector_list_dict
...
val _ = Define `
 ((duplicate_fail0:bitU -> int -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) b n=  (sail2_state_monad$returnS (duplicate0 b n)))`;

val _ = Define `
 ((duplicate_nondet0:bitU -> int -> 'a sail2_state_monad$sequential_state ->(((bitU)list),'b)sail2_state_monad$result#'a sail2_state_monad$sequential_state) b n=  (sail2_state_monad$bindS
