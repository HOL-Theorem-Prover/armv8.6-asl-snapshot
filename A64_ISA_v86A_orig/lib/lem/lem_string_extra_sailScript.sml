...
open lem_numTheory lem_listTheory lem_basic_classesTheory lem_string_sailTheory lem_list_extra_sailTheory ASCIInumbersTheory stringLib;

val _ = numLib.prefer_num();



val _ = new_theory "lem_string_extra_sail"
